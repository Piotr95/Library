...
import java.util.List;
    ...
    public class SwaggerAuthConfiguration extends ApiListingScanner {
        @Autowired
        private TypeResolver typeResolver;

        @Autowired
        public SwaggerAuthConfiguration(ApiDescriptionReader apiDescriptionReader, ApiModelReader apiModelReader, DocumentationPluginsManager pluginsManager) {
